                        ...
                        <tbody>
                            @foreach ($list_paramedik as $paramedik)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a  href="{{ route('paramedik.show', $paramedik->id) }}" class="btn btn-primary mr-2"><i class="bi bi-eye"></i></a>
                                        <a  href="{{ route('paramedik.edit', $paramedik->id) }}" class="btn btn-warning mr-2"><i class="bi bi-pencil-square"></i></a>

                                        <form action="{{ route('paramedik.destroy', $paramedik->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                                @csrf
                                                @method('DELETE')
