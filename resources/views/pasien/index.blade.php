                        ...
                        <tbody>
                            @foreach ($list_pasien as $pasien)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a  href="{{ route('pasien.show', $pasien->id) }}" class="btn btn-primary mr-2"><i class="bi bi-eye"></i></a>
                                        <a  href="{{ route('pasien.edit', $pasien->id) }}" class="btn btn-warning mr-2"><i class="bi bi-pencil-square"></i></a>
